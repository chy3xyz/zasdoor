...
| 层 | 技术 |
| --- | --- |
| 后端 | [Zig](https://ziglang.org) 0.17 · [zigmodu](https://github.com/chy3xyz/zigmodu) v0.15.21+(HTTP、安全、AI、resilience、Application 生命周期) · [zent](https://github.com/chy3xyz/zent) v0.29.3+(ORM、schema、迁移) |
...
| ✅ 已完成 | **依赖升级到最新** —— zigmodu v0.15.21 + zent v0.29.3;zent `migrate.zig` 提升 comptime 分支配额(`10ab9ce`),15+ 表 schema 可编译 |
